...
let k = (loc) => {
    ...
    o.ondeath = () => {
        ...
        n.team = team || -100;
        n.SIZE = 75;
        n.isDominator = true; // Do not collide with players.
        if (pwned >= -4 || pwned <= -1) {
            if (pwned == -1) {
                sockets.broadcast(
...
setInterval(function() {
    ...
    if (ArenaClosed == true) {
        ...
        setTimeout(function() {
            ...
            setTimeout(function() {
                sockets.broadcast("New objective: Survive")
            }, 2000)
            ...
            setInterval(function() {
                if (loops < 16) {
                    ...
                    o.define(Class.arenaCloser); //put whatever you want to spawn at the end here
                    o.team = -100;
